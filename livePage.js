getTemplate = require("./template.js");

module.exports = {
  livePage : function (title) {
    const openAPIkey =
      ""; //openData
    const cctvId = "L280034";
    const cctvUrl = `http://www.utic.go.kr/view/map/openDataCctvStream.jsp?key=${openAPIkey}&cctvid=${cctvId}&kind=t&cctvch=19`;
    const tMapAPIKEY = "";
    const startX = 126.803066712453;
    const startY = 37.4637380346779;
    const endX = 127.058338066917;
    const endY = 37.6193203481648;
    return `<!DOCTYPE html>
            <html>
                <head>
                    <title>${title}</title>
